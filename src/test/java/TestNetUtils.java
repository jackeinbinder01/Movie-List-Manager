...
public class TestNetUtils {
    ...
    public void TestGetMediaDetails() throws IOException {
        ...
        String expected1 = Files.readString(Paths.get("src/test/testing_resources/TheMatrix.json"));;
        String expected2 = Files.readString(Paths.get("src/test/testing_resources/matrix.json"));
